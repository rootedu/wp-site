...
<div id="shaon-pricing-table-plus" class="green">
	<div class="minimal">
		...
		foreach ( $data as $key => $value ) {
			...
			<div class="highlight plan p1<?php if ( $featured == $key ) { echo " featured"; } ?>">
				...
				<h4>
					<span class="amount"><span><?php echo $currency; ?></span><?php echo $value['Price']; ?></span><span class="interval"><?php echo $value['Detail']; ?></span>
				</h4>
				...
				<div class="features">
					<ul>
						...
						?>
						<li><a class="pt-button" href="<?php echo $value['Button URL'] ?>"><span><?php echo $value['Button Text'] ?></span></a></li>
					</ul>
				</div>
			</div>
		<?php } ?>
