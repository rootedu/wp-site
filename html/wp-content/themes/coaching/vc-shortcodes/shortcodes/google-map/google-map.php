...
function thim_shortcode_google_map( $atts ) {
    ...
    $instance['markers']['marker_positions'] = (array) vc_param_group_parse_atts( $instance['marker_positions'] );
	...
	$map_data = array(
        ...
        'marker-positions' => isset( $instance['markers']['marker_positions'] ) ? json_encode( $instance['markers']['marker_positions'] ) : '',
		'api-key'          => $api_key
	);
