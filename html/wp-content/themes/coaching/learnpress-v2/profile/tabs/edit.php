...
if ( thim_is_new_learnpress( '2.1.1' ) ) {
	...
	$edit_tabs = array(
		'basic-information' => __( 'Basic Information', 'coaching' ),
		'avatar'            => __( 'Avatar', 'coaching' ),
		'change-password'   => __( 'Change Password', 'coaching' ),
	);
	...
	<div id="lp-user-profile-form" class="lp-user-profile-form">
		<form id="your-profile" method="post" name="lp-edit-profile">
			...
			<p class="submit update-profile">
				<input disabled="disabled" type="submit" name="submit" id="submit" class="button button-primary" value="<?php _e( 'Update', 'coaching' ); ?>" />
			</p>
		</form>
	</div>
	<?php
		...
		<div class="user-profile-edit-form" id="learn-press-user-profile-edit-form">
			<form id="your-profile" action="" method="post" enctype="multipart/form-data" novalidate="novalidate">
				...
				<div class="user-profile-picture info-field">
					...
					<div id="profile-picture-wrap">
						...
						<ul id="lp-menu-change-picture">
							<li class="dropdown">
								<span class="lp-label-change-picture"><?php _e( 'Change Picture', 'coaching' ); ?></span>
								<select name="profile_picture_type" id="lp-profile_picture_type" class="hidden">
									<option value="gravatar" <?php selected( 'gravatar', $profile_picture_type ) ?>><?php _e( 'Gravatar', 'coaching' ); ?></option>
									<option value="picture" <?php selected( 'picture', $profile_picture_type ) ?>><?php _e( 'Picture', 'coaching' ); ?></option>
								</select>
								<ul class="dropdown-menu" role="menu">
									<li class="menu-item-use-gravatar<?php echo esc_attr( $class_gravatar_selected ); ?>">
										<span><?php _e( 'Use Gravatar', 'coaching' ); ?></span></li>
									<li class="menu-item-use-picture<?php echo esc_attr( $class_picture_selected ); ?>">
										<span><?php _e( 'Use Picture', 'coaching' ); ?></span></li>
									<li class="menu-item-upload-picture">
										<span><?php _e( 'Upload Picture', 'coaching' ); ?></span></li>
								</ul>
					...
					<div id="lpbox-upload-crop-profile-picture">
						...
						<div class="lpbox-title"><?php _e( 'Upload Picture', 'coaching' ); ?></div>
						<p class="description">
							<small><?php _e( 'Please use an image that\'s at least 250px in width, 250px in height and under 2MB in size', 'coaching' ); ?></small>
						</p>
						<div id="image-editor-wrap">
							...
							<div class="image-editor-sidebar-right">
								<a href="#" id="lp-button-choose-file"><span class="dashicons dashicons-format-image"></span><?php _e( 'Choose File', 'coaching' ); ?>
								</a>
								<a href="#" id="lp-button-apply-changes"><span class="dashicons dashicons-yes"></span>&nbsp;<?php _e( 'Apply Changes', 'coaching' ); ?>
								</a>
								<a href="#" id="lp-button-cancel-changes"><span class="dashicons dashicons-no"></span><?php _e( 'Cancel', 'coaching' ); ?>
								</a>
				...
				<div class="change-password">
					<a href="#" id="learn-press-toggle-password" class="link-change-password"><?php esc_html_e( 'Change Password', 'coaching' ); ?></a>
				...
				<p class="submit update-profile">
					<input type="submit" name="submit" id="submit" class="button button-primary" value="<?php _e( 'Update Profile', 'coaching' ); ?>" />
				</p>
			</form>
		</div>
