...
<table class="table-orders">
	<thead>
		<th><?php _e( 'Order', 'coaching' );?></th>
		<th><?php _e( 'Date', 'coaching' );?></th>
		<th><?php _e( 'Status', 'coaching' );?></th>
		<th><?php _e( 'Total', 'coaching' );?></th>
		<th><?php _e( 'Action', 'coaching' );?></th>
	</thead>
	<tbody>
			...
			<td>
                            ...
                            <?php
                                if ( $order->has_status( 'pending' ) ) :
                                    printf( '(<small><a href="%s" class="%s">%s</a></small>)', $order->get_cancel_order_url(), 'cancel-order', __( 'Cancel', 'coaching' ) );
                                endif;
                            ?>
                        </td>
...
<?php else: ?>
	<?php learn_press_display_message( __( 'You have not got any orders yet!', 'coaching' ), 'notice' ); ?>
<?php endif; ?>
