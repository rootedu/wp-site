...
$submit_button_process_text = esc_html__( 'Processing', 'coaching' );
$submit_button_text         = esc_html__( 'Submit', 'coaching' );
...
<div class="become-teacher-form<?php echo $is_logged_in ? ' allow' : ''; ?>">
	...
	<?php if ( !$is_logged_in ) { ?>
		<p class="message message-info"><?php printf( __( 'You have to <a class="login" href="%s">login</a> to fill out this form', 'coaching' ), add_query_arg( 'redirect_to', get_permalink(), thim_get_login_page_url() ) ); ?></p>
	<?php } ?>
