...
$heading       = sprintf( esc_html__( 'Other results (Latest %d items)', 'coaching' ), $limit );
?>
...
if ( $history_count > 1 ) {
	...
	<div class="lp-group-content-wrap" id="lp-quiz-history">
		<table class="quiz-history">
			...
			<tr>
				...
				<th><?php esc_html_e( 'Time', 'coaching' ); ?></th>
				<th><?php esc_html_e( 'Result', 'coaching' ); ?></th>
			</tr>
			</thead>
	...
	learn_press_display_message( __( 'No history found!', 'coaching' ), 'notice');
}