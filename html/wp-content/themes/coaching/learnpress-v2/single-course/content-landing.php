...
$arr_variable = array();
$arr_variable['description'] = array("title"=>esc_html__( 'Description', 'coaching' ), "icon"=>"fa-bookmark");
$arr_variable['curriculum'] = array("title"=>esc_html__( 'Curriculum', 'coaching' ), "icon"=>"fa-cube");
$arr_variable['instructor'] = array("title"=>esc_html__( 'Instructors', 'coaching' ), "icon"=>"fa-user");
$arr_variable['review'] = array("title"=>esc_html__( 'Review', 'coaching' ), "icon"=>"fa-comments");
			...
			<?php if ( $student_list_enable ) : ?>
				<li role="presentation">
					<a href="#tab-course-student-list" data-toggle="tab">
						...
						<span><?php esc_html_e( 'Student List', 'coaching' ); ?></span>
					</a>
				</li>
			<?php endif; ?>
		</ul>
