    ...
    <div class="learn-press-subtab-content">
        ...
        <ul class="lp-form-field-wrap">
            ...
            <li class="lp-form-field">
                <label for="lp-form-field-label"><?php _e( 'Biographical Info', 'coaching' ); ?></label>
            ...
            <li class="form-field">
                <label for="lp-form-field-label"><?php _e( 'First Name', 'coaching' ); ?></label>
                <div class="lp-form-field-input">
            ...
            <li class="form-field">
                <label for="lp-form-field-label"><?php _e( 'Last Name', 'coaching' ); ?></label>
                <div class="lp-form-field-input">
            ...
            <li class="form-field">
                <label for="lp-form-field-label"><?php _e( 'Nickname', 'coaching' ); ?></label>
                <div class="lp-form-field-input">
            ...
            <li class="form-field">
                <label for="lp-form-field-label"><?php _e( 'Display name publicly as', 'coaching' ); ?></label>
                <div class="lp-form-field-input">
        ...
        <button type="submit" name="submit"><?php _e( 'Save changes', 'coaching' ); ?></button>
    </div>
