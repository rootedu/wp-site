...
<form method="post" id="your-profile" name="profile-publicity" enctype="multipart/form-data" class="learn-press-form">
    ...
    <div class="learn-press-subtab-content">
        ...
        <ul class="form-fields">
            ...
            <li class="form-field">
                <label for="my-dashboard"><?php _e( 'My dashboard', 'coaching' ); ?></label>
                <div class="form-field-input">
                    ...
                    <p class="description"><?php _e( 'Public your profile dashboard', 'coaching' ); ?></p>
                </div>
            </li>

            <?php if ( LP()->settings()->get( 'profile_publicity.courses' ) === 'yes' ) { ?>
                <li class="form-field">
                    <label for="my-courses"><?php _e( 'My courses', 'coaching' ); ?></label>
                    <div class="form-field-input">
                        <input type="checkbox" name="publicity[courses]" value="yes"
                               id="my-course" <?php checked( $profile->get_publicity( 'courses' ), 'yes' ); ?>/>
                        <p class="description"><?php _e( 'Public your profile courses', 'coaching' ); ?></p>
                    </div>
                </li>
            <?php } ?>
            ...
            <?php if ( LP()->settings()->get( 'profile_publicity.quizzes' ) === 'yes' ) { ?>
                <li class="form-field">
                    <label for="my-quizzes"><?php _e( 'My quizzes', 'coaching' ); ?></label>
                    <div class="form-field-input">
                        <input name="publicity[quizzes]" value="yes" type="checkbox"
                               id="my-quizzes" <?php checked( $profile->get_publicity( 'quizzes' ), 'yes' ); ?>/>
                        <p class="description"><?php _e( 'Public your profile quizzes', 'coaching' ); ?></p>
                    </div>
                </li>
            <?php } ?>
        ...
        <button type="submit" name="submit" id="submit"><?php _e( 'Save changes', 'coaching' ); ?></button>
    </div>
