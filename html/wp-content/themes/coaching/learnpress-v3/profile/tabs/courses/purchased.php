...
<div class="learn-press-subtab-content">
	...
	<?php if ( $query['items'] ) { ?>
        <table class="lp-list-table profile-list-courses profile-list-table">
            <thead>
            <tr>
                <th class="column-course"><?php _e( 'Course', 'coaching' ); ?></th>
                <th class="column-date"><?php _e( 'Date', 'coaching' ); ?></th>
                <th class="column-passing-grade"><?php _e( 'Passing Grade', 'coaching' ); ?></th>
                <th class="column-status"><?php _e( 'Progress', 'coaching' ); ?></th>
            </tr>
            </thead>
            <tbody>
	...
	<?php } else {
		learn_press_display_message( __( 'No courses!', 'coaching' ) );
	} ?>
</div>
