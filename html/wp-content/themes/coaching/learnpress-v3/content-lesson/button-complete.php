...
<form method="post" name="learn-press-form-complete-lesson"
	...
	<?php if ( $completed ) { ?>
        ...
        <button><i class="fa fa-check"></i> <?php echo __( 'Completed', 'coaching' ); ?></button>
	...
	<?php } else { ?>
        ...
        <button class="lp-button button button-complete-item button-complete-lesson"><?php echo __( 'Complete', 'coaching' ); ?></button>
