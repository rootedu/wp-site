...
<div class="quiz-clock">
    <div class="quiz-total">
        ...
        <div class="quiz-text"><?php echo '<span class="number">' . $quiz->count_questions() . '</span> '; ?><?php echo $quiz->count_questions() > 1 ? esc_html__( 'Questions', 'coaching' ) : esc_html__( 'Question', 'coaching' ); ?></div>
    </div>
