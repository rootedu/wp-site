    ...
    <div class="progress-items">
        <div class="progress-item quiz-current-question quiz-total">
            ...
            <span class="progress-number quiz-text">
                <?php _e( 'Question', 'coaching' ); ?>
                <span class="number">
                    <?php echo sprintf( __( '%d/%d', 'coaching' ), $quiz->get_question_index( $question ? $question->get_id() : $quiz_data->get_current_question(), 1 ), $quiz_data->get_total_questions() ); ?>
                </span>
            </span>
        </div>
