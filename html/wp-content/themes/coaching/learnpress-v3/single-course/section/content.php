            ...
            <li class="<?php echo join( ' ', $item->get_class() ); ?>" data-type="<?php echo $item->get_item_type(); ?>">
                ...
                <div class="meta-left">
                    ...
                    <?php if ( $item->get_item_type() == 'lp_quiz' ) {?>
                        <div class="index"><?php echo '<span class="label">' . esc_html__( 'Quiz', 'coaching' ) . '</span>' . $section->get_order() . '.' . $count[$post_type]; ?></div>
                    <?php } else {?>
                        <div class="index"><?php echo '<span class="label">' . esc_html__( 'Lecture', 'coaching' ) . '</span>' . $section->get_order() . '.' . $count[$post_type]; ?></div>
                    <?php }?>
                </div>
