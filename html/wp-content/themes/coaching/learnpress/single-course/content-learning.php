		...
		<ul class="nav nav-tabs">
			<li role="presentation">
				<a href="#tab-course-description" data-toggle="tab">
					...
					<span><?php esc_html_e( 'Description', 'coaching' ); ?></span>
				</a>
			</li>
			<li class="active">
				<a href="#tab-course-curriculum" data-toggle="tab">
					<i class="fa fa-cube"></i>
					<span><?php esc_html_e( 'Curriculum', 'coaching' ); ?></span>
				</a>
			</li>
			<li role="presentation">
				<a href="#tab-course-instructor" data-toggle="tab">
					<i class="fa fa-user"></i>
					<span><?php esc_html_e( 'Instructors', 'coaching' ); ?></span>
				</a>
			</li>
			<?php if ( $review_is_enable ) : ?>
				<li role="presentation">
					<a href="#tab-course-review" data-toggle="tab">
						...
						<span><?php esc_html_e( 'Reviews', 'coaching' ); ?></span>
