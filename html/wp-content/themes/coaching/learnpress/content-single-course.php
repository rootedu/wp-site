	...
	<?php if ( $is_required && !$is_enrolled ) : ?>
		...
		<?php if ( $user->has( 'purchased-course', $course->id ) ) : ?>
			...
			<?php if ( ! $user->can( 'enroll-course', $course->id ) ) : ?>
				...
				<?php learn_press_display_message( apply_filters( 'learn_press_user_purchased_course_message', esc_html__( 'You have already purchased this course. Please wait for approve', 'coaching' ), $course, $user ) , 'notice' ); ?>
		...
		<?php elseif ( $user->can( 'purchase-course', $course->id ) ) : ?>
			...
			<?php if ( LP()->cart->has_item( $course->id ) ) : ?>
				...
				<?php learn_press_display_message( esc_html__( 'This course is already added to your cart', 'coaching' ), 'notice' ); ?>
		...
		<?php else: ?>
			...
			<?php learn_press_display_message( apply_filters( 'learn_press_user_can_not_purchase_course_message', esc_html__( 'Sorry, you can not purchase this course', 'coaching' ), $course, $user ), 'error' ); ?>
