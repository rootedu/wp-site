...
?>
<div id="learn-press-question-explanation-<?php echo esc_attr( $quiz->current_question->id ); ?>" class="question-explanation-content hide-if-js">
	<?php echo ent2ncr( $explanation ); ?>
</div>