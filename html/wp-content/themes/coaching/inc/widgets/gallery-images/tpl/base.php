...
if ( $instance['image'] ) {
	...
	echo '<div class="thim-carousel-wrapper gallery-img ' . esc_attr( $css_animation ) . '" ' . $number . $item_tablet . $item_mobile . ' data-pagination="'. esc_attr( $pagination ). '" data-autoplay="'.esc_attr($autoplay).'"  data-autoplaytimeout="'. esc_attr($timeout) .'">';
	$i = 0;
